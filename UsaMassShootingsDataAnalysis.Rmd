 ...
 * The Gender based exploration shows that most of the attacks were carried out by males. 
 ...
 * The provine based comparison of victims show that most effected state is Naveda. Naveda reported high number of victims because it recenctly witnesed a mass shooting which was one of the most horrible attack in USA's history.    
...
ggplot(shootings,aes(x=Race,y=Total.victims))+
  ...
  labs(x="Race",y="Number Of Victims",title = "Race Based Comparison Of victims")+
  theme_bw()+
  coord_flip()+
  theme(plot.title = element_text(hjust = 0.5,size = 14))
```
